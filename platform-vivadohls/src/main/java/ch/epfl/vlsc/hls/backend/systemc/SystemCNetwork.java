...
public interface SystemCNetwork {
    ...
    default SCInstance findSCInstance(Instance instance) {
        ...
        if (!instances().containsKey(instance)) {
            ...
            SCInstance newInst = new SCInstance(name, readers.build(), writers.build(), actionIds, false);
    ...
    default void getIncludeInstance(SCInstance instance) {
        if(useVerilator())
            ...
            emitter().emit("#include \"systemc/%s.h\" // generated by VivadoHLS", instance.getName());
    }
